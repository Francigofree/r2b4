...
class _V3ResidentRaisedStandGateway:
    ...
    def __init__(self, max_warmup_tick_id: int = V3_NATIVE_RESIDENT_MAX_WARMUP_TICK_ID):
        if (
    ...
    def snapshot(self, context: Any) -> Any:
        ...
        active = int(context.tick_id) == self.active_tick_id
    ...
    def observe(self, summary: Mapping[str, Any]) -> str:
        ...
        if healthy_idle:
            ...
            self.post_active_idle_tick_id = tick_id + 2
            self.shutdown_tick_id = tick_id + 3
            return "ARMED"
