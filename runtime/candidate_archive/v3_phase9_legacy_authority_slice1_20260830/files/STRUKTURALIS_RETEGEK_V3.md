...
9. **Legacy eltávolítás — folyamatban:** az első célzott szelet kivette a
   ...
   tesztbelépési pontját. Az `AlbaMotor` egyelőre könyvtári legacy dependencyként
   megmarad a canonical `os.py` default számára; ez a szelet nem kapcsol át
   runtime-ot és nem indít élő mozgást. A GUI/tool/shared-state authority és a
   fennmaradó régi motorutak kivonása további külön, célzott taskokban történik.
