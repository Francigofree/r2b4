...
class BoundedLiveControlConfig:
    ...
    def __post_init__(self) -> None:
        if not isinstance(
            ...
            (BoundedTeleopProfile, BoundedExploreProfile),
        ):
...
class BoundedLiveControlComposition:
    ...
    def __init__(
        ...
        self._gateway = (
            ...
            if isinstance(config.command_profile, BoundedExploreProfile)
            else BoundedTeleopCommandGateway(config.command_profile)
        )
