...
V3_NATIVE_MOTION_APPROVAL = "motor-power-off-hard-low-v3"
...
def _scenario_registry() -> Dict[str, ScenarioProfile]:
    ...
    return {
        V3_NATIVE_RAISED_STAND_PROFILE: ScenarioProfile(
            ...
            description=(
                "Finite native V3 motor-power-off signal validation through the "
            ...
            goals=(
                ...
                "explicit per-run motor-power-off approval with no approval embedded in the profile",
                "one 20 ms 0.04 m/s command pulse with motor power physically disconnected",
...
def _run_v3_native_raised_stand_motion(approval: str) -> Dict[str, Any]:
    ...
    if approval != V3_NATIVE_MOTION_APPROVAL:
        return {
            ...
            "status": "FAIL",
            "success": False,
            "error": "explicit_motor_power_off_approval_required",
        }
    ...
    try:
        ...
        payload = {
            ...
            "approval": approval,
            "motor_power": "OFF_BY_EXPLICIT_APPROVAL",
