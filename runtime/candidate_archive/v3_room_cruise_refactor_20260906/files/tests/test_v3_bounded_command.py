...
def test_bounded_explore_is_a_high_level_consumer_of_the_same_l5_gateway():
    profile = BoundedExploreProfile(
    ...
    gateway = BoundedExploreCommandGateway(profile)
    ...
    assert mission.mode is CommandMode.EXPLORE
