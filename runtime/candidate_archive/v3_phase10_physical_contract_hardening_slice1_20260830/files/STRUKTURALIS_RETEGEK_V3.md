...
9. **Legacy containment — a szükséges alsó határig lezárva:** az első célzott
   szelet kivette a
...
10. **V3 hardening és fizikai contract-paritás — folyamatban:** az első native
    ...
    nem nulla output vagy új felső szintű komponens.
11. **Live input és ACTIVE-ready runtime — tervezett:** csak a phase-10 kapuk
    lezárása után; az ACTIVE-ready nem jelent automatikus ACTIVE engedélyezést.
