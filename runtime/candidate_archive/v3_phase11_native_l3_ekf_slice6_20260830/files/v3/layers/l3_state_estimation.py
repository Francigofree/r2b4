...
class NativeStateEstimator:
    """Minimal native five-state EKF over admitted wheel and heading samples.
    ...
    and covariance stabilization. Inputs absent from the V3 L3 contract (raw
    acceleration, command context and absolute lidar pose) are not fabricated.
    """
