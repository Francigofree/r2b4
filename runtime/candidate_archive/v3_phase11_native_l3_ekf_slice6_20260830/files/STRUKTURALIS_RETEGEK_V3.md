...
11. **Live input és ACTIVE-ready runtime — folyamatban:** a phase-10 kapuk
    ...
    szerepben marad. A jelenlegi L3 contractban nem létező raw acceleration,
    command-context és abszolút lidar-pose ág nem lett kitalált bemenettel vagy
    legacy hozzáféréssel pótolva; ezek későbbi typed inputbővítést igényelnek.
    Nincs production `middleware`, NumPy, shared state, API/runtime dependency,
    falióra, thread vagy hardverimport.
