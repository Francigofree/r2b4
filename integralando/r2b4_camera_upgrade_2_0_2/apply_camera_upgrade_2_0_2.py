...
EXPECTED_BASE = "9fc8f179b5ed5ed5d0bf28eb0c4305fffe8edaea"
...
def patch_resident_tests(text: str) -> str:
    text = replace_once(text,
...
def main() -> int:
    ...
    patchers = {
        ...
        "tests/test_v3_resident_runtime.py": patch_resident_tests,
    ...
    if args.check:
        print("camera upgrade 2.0.2 structural compatibility: PASS")
    ...
    try:
        ...
        pass
    print("R2B4 camera robustness upgrade 2.0.2 applied")
