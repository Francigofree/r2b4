...
SUPPORTED_CAPTURE_SCHEMAS = frozenset({CAPTURE_SCHEMA, CAPTURE_SCHEMA_V2})
SUPPORTED_FRAME_SCHEMAS = frozenset({FRAME_SCHEMA, FRAME_SCHEMA_V2})
SUPPORTED_REPLAY_RESULT_SCHEMAS = frozenset({REPLAY_RESULT_SCHEMA, REPLAY_RESULT_SCHEMA_V2})
SUPPORTED_REPLAY_EVIDENCE_SCHEMAS = frozenset({REPLAY_EVIDENCE_SCHEMA, REPLAY_EVIDENCE_SCHEMA_V2})
