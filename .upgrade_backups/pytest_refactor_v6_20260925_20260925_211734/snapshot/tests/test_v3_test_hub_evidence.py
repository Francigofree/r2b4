"""Test Hub evidence/replay ownership tests, grouped by responsibility."""
...
from v3.test_hub_v2 import TestHubV2Error as HubError
...
def test_test_hub_preserves_fault_verdict_but_passes_matching_partial_replay(
    tmp_path,
):
...
def test_test_hub_indexes_source_first_navigation_and_local_perception_coverage(
    tmp_path,
):
    capture = create_explore_capture(tmp_path)
...
def test_existing_evidence_is_preserved_and_not_reused_for_new_replay_scope(
    tmp_path,
):
