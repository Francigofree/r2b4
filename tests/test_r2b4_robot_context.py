    ...
    def capabilities(self):
        return {
            ...
            "capabilities": {
                ...
                "v3.command.face_person": {"kind": "action", "supported": True, "available": False, "ready": False, "reason": "NO_PERSON"},
                "host.shutdown": {"kind": "action", "supported": True, "available": True, "ready": True},
            },
        }

    def read(self, name):
        return {
            "v3.status": {"state": "RUNNING", "ready_for_active": True, "tick_id": 10, "enabled": False, "fault_layer": None},
